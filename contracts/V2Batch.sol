...
contract BatchFlashDemo is FlashLoanReceiverBase, Ownable {
    ...
    constructor(ILendingPoolAddressesProvider _addressProvider, address _usdcAddress, address _amUsdcAddress, uint256 _borrowMode) FlashLoanReceiverBase(_addressProvider) public {
